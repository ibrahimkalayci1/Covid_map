...
import { ComposableMap, Geographies,Sphere, Graticule, Geography,ZoomableGroup } from "react-simple-maps"
...
console.log(geo)
return (
    <div className=' h-[calc(100vh-100px)] text-white overflow-hidden flex flex-col justify-center items-center md:pt-20 wrapper'>
      <h1 className=' pb-6'>
        Detay Görüntüle {""}
